...
class MessageHandler:
    ...
    def handle_message(self, message: str, phone_from: str):
        ...
        #Send the response to the user
        response = self.send_message(response['message'], from_, image=response['qrcode_url'])

        logging.info(f"Message sent to user: {from_}")

        return response
    
    def send_message(self, message: str, to_phone_number: str, image: str):
        """
        ...
        chat_handler.send_message(message, to_phone_number, image_url="https://images.unsplash.com/photo-1545093149-618ce3bcf49d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=668&q=80")
